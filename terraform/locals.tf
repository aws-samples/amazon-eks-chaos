locals {
  ...
  gitops_workload_url      = var.workload_repo
  ...
  aws_addons = {
    ...
    enable_aws_for_fluentbit                     = try(var.addons.enable_aws_for_fluentbit, true)
  ...
  #---------------------------------------------------------------
  # workload_repo = "https://amazon-eks-chaos-demo-codecommit-at-959472914689:X%2bTKYU%2b0fria6KXr4u7Ne8BL65jH%2b3QScN1%2f52ZZGGU=@git-codecommit.ap-southeast-1.amazonaws.com/v1/repos/chaos_gitops_repository"
  /*
  workload_repo = var.workload_repo

  workload_application = {
    path               = "deploy/k8s/helm/argocd"
